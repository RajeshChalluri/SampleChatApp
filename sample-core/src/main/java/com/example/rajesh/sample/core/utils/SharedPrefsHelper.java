package com.example.rajesh.sample.core.utils;
...
public class SharedPrefsHelper {
    public static final String SHARED_PREFS_NAME = "qb";
    private static final int MODE = Context.MODE_PRIVATE;    // mode
    ...
    private SharedPrefsHelper() {
        instance = this;
        sharedPreferences = CoreApp.getInstance().getSharedPreferences(SHARED_PREFS_NAME, MODE);
    }
