...
import com.example.rajesh.sample.core.gcm.GooglePlayServicesHelper;
...
import com.example.rajesh.samplechatapp.adapters.DialogsAdapter;
import com.example.rajesh.samplechatapp.utils.Constants;
import com.example.rajesh.samplechatapp.utils.QbDialogHolder;
...
public class DialogsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googlePlayServicesHelper.checkPlayServicesAvailable(this)) {
            googlePlayServicesHelper.registerForGcm(Constants.GCM_SENDER_ID);
        }
    ...
    private void userLogout() {
        if (ChatHelper.getInstance().logout()) {
            if (googlePlayServicesHelper.checkPlayServicesAvailable()) {
                googlePlayServicesHelper.unregisterFromGcm(Constants.GCM_SENDER_ID);
            }
