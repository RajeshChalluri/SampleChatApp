package com.example.rajesh.samplechatapp.adapters;
...
import com.example.rajesh.sample.core.ui.adapter.BaseListAdapter;
import com.example.rajesh.sample.core.utils.ResourceUtils;
import com.example.rajesh.samplechatapp.R;
import com.example.rajesh.samplechatapp.activities.AttachmentImageActivity;
...
import com.example.rajesh.samplechatapp.utils.QbUsersHolder;
import com.example.rajesh.samplechatapp.utils.TimeUtils;
import com.example.rajesh.samplechatapp.utils.chat.ChatHelper;
import com.example.rajesh.samplechatapp.widget.MaskedImageView;
    ...
    private void setMessageBody(final ViewHolder holder, QBChatMessage chatMessage) {
        if (hasAttachments(chatMessage)) {
            ...
            Glide.with(context)
                    ...
                    .override(Constants.PREFERRED_IMAGE_SIZE_PREVIEW, Constants.PREFERRED_IMAGE_SIZE_PREVIEW)
                    .dontTransform()
